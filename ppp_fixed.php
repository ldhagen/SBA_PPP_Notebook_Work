...
// Add the missing sanitizeInput function
...
// Extended search parameters - adding more fields
...
// Database operations
$should_search = $search_term || $company_name || $city || $state_filter || $min_amount > 0 || $max_amount > 0 || $loan_number || $show_top;
...
if ($should_search) {
    try {
        ...
        if ($total_results > 0) {
            ...
            $main_sql = "SELECT * FROM loans $where_clause ORDER BY InitialApprovalAmount DESC LIMIT $offset, $per_page";
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Search 968,524 PPP loan records with advanced options</p>
        </div>
